  ...
  const testimonials = [
    {
      ...
      content: "E-Tax CPA saved my business thousands in taxes through their proactive planning. Their expertise in Austin's business landscape is unmatched.",
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Don't just take our word for it. Here's what Austin businesses and individuals 
            have to say about working with E-Tax CPA.
          </p>
        </div>
